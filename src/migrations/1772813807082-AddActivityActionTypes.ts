...
export class AddActivityActionTypes1772813807082 implements MigrationInterface {
    name = 'AddActivityActionTypes1772813807082'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "plan_config_entity" ADD "localPriceIds" text`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "plan_config_entity" DROP COLUMN "localPriceIds"`);
    }
